...
/**
 * Every piece of app configuration lives here rather than in main.ts, because
 * the serverless entrypoint needs exactly the same setup and a second copy of
 * it would drift the moment either side is edited.
 */
export async function createApp(): Promise<INestApplication> {
  ...
  const config = new DocumentBuilder()
    ...
    .addTag('public', 'Reader-facing routes that need no token')
    .addTag('uploads', 'Image and avatar uploads')
